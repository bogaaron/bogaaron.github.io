...
SimpleExponentialSmoothing = function(data, alpha)
{
	if(data == null)
	{
...
SimpleExponentialSmoothing.prototype.computeMeanSquaredError = function()
{
	var SSE = 0.0;
	var n = 0;
...
DoubleExponentialSmoothing = function(data, alpha)
{
	if(data == null)
	{
		throw "data parameter is null";
...
DoubleExponentialSmoothing.prototype.predict =function (horizon)
{
...
DoubleExponentialSmoothing.prototype.getForecast = function()
{
	if(this.forecast == null)
	{
		return null;
...
DoubleExponentialSmoothing.prototype.computeMeanSquaredError = function()
{
	var SSE = 0.0;
	var n = 0;
	for(var i = 0; i < this.data.length; ++i)
...
DoubleExponentialSmoothing.prototype.optimizeParameter = function(iter)
{
	var incr = 1/iter;
	var bestAlpha = 0.0;
	var bestError = -1;
...
/*Holt smoothing */
HoltSmoothing = function(data, alpha, gamma)
{
	if(data == null)
	{
		throw "data parameter is null";
...
HoltSmoothing.prototype.predict =function (horizon)
{
	A = Array();
	B = Array();
...
HoltSmoothing.prototype.getForecast = function()
{
	if(this.forecast == null)
	{
		return null;
...
HoltSmoothing.prototype.computeMeanSquaredError = function()
{
	var SSE = 0.0;
...
HoltSmoothing.prototype.optimizeParameters = function(iter)
{
	var incr = 1/iter;
	var bestAlpha = 0.0;
	var bestError = -1;
...
HoltWintersSmoothing.prototype.getForecast = function()
{
	if(this.forecast == null)
	{
		this.predict();
...
MovingAverage.prototype.smooth = function(order)
{
	if(order < 1)
	{
